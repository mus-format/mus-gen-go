...
type TypeFn[T scanner.QualifiedName] func(t scanner.TypeInfo[T], tops tpopts.Options) error
...
func (o Op[T]) ProcessType(t scanner.TypeInfo[T], tops tpopts.Options) (err error) {
	result, err := o.Call("ProcessType", t, tops)
	if err != nil {
		panic(err)
	}
