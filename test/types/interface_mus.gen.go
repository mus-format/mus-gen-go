...
func (s interfaceMUS) Marshal(v Interface, bs []byte) (n int) {
	switch t := v.(type) {
	case Impl1:
		return Impl1TypedMUS.Marshal(t, bs)
	case Impl2:
		return Impl2TypedMUS.Marshal(t, bs)
	default:
...
func (s interfaceMUS) Unmarshal(bs []byte) (v Interface, n int, err error) {
	...
	switch dtm {
	case Impl1DTM:
		v, n1, err = Impl1TypedMUS.UnmarshalData(bs[n:])
	case Impl2DTM:
		v, n1, err = Impl2TypedMUS.UnmarshalData(bs[n:])
	default:
...
func (s interfaceMUS) Size(v Interface) (size int) {
	switch t := v.(type) {
	case Impl1:
		return Impl1TypedMUS.Size(t)
	case Impl2:
		return Impl2TypedMUS.Size(t)
	default:
		panic(fmt.Sprintf(com.ErrorPrefix+"unexpected %v type", t))
	}
}
