...
var (
	stringX0PwU23BcCESwmTbgΔZ1ogΞΞ = ord.NewValidStringSer(strops.WithLenValidator(com.ValidatorFn[int](testutil.ValidateLength3)))
	stringw34tGwΔtΣ2CMjNLGw8rplQΞΞ = ord.NewValidStringSer(strops.WithLenSer(raw.Int), strops.WithLenValidator(com.ValidatorFn[int](testutil.ValidateLength3)))
	stringw6Nu8ceL6d7SBUZRdlWEwQΞΞ = ord.NewStringSer(strops.WithLenSer(raw.Int))
)
...
func (s validMyIntMUS) Unmarshal(bs []byte) (v ValidMyInt, n int, err error) {
	...
	v = ValidMyInt(tmp)
	err = testutil.ValidateZeroValue(v)
	return
}
...
func (s lenEncodingMyStringMUS) Marshal(v LenEncodingMyString, bs []byte) (n int) {
	return stringw6Nu8ceL6d7SBUZRdlWEwQΞΞ.Marshal(string(v), bs)
}

func (s lenEncodingMyStringMUS) Unmarshal(bs []byte) (v LenEncodingMyString, n int, err error) {
	tmp, n, err := stringw6Nu8ceL6d7SBUZRdlWEwQΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
...
func (s lenEncodingMyStringMUS) Size(v LenEncodingMyString) (size int) {
	return stringw6Nu8ceL6d7SBUZRdlWEwQΞΞ.Size(string(v))
}

func (s lenEncodingMyStringMUS) Skip(bs []byte) (n int, err error) {
	return stringw6Nu8ceL6d7SBUZRdlWEwQΞΞ.Skip(bs)
}
...
func (s lenValidMyStringMUS) Marshal(v LenValidMyString, bs []byte) (n int) {
	return stringX0PwU23BcCESwmTbgΔZ1ogΞΞ.Marshal(string(v), bs)
}

func (s lenValidMyStringMUS) Unmarshal(bs []byte) (v LenValidMyString, n int, err error) {
	tmp, n, err := stringX0PwU23BcCESwmTbgΔZ1ogΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
...
func (s lenValidMyStringMUS) Size(v LenValidMyString) (size int) {
	return stringX0PwU23BcCESwmTbgΔZ1ogΞΞ.Size(string(v))
}

func (s lenValidMyStringMUS) Skip(bs []byte) (n int, err error) {
	return stringX0PwU23BcCESwmTbgΔZ1ogΞΞ.Skip(bs)
}
...
func (s allMyStringMUS) Marshal(v AllMyString, bs []byte) (n int) {
	return stringw34tGwΔtΣ2CMjNLGw8rplQΞΞ.Marshal(string(v), bs)
}

func (s allMyStringMUS) Unmarshal(bs []byte) (v AllMyString, n int, err error) {
	tmp, n, err := stringw34tGwΔtΣ2CMjNLGw8rplQΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
	v = AllMyString(tmp)
...
func (s allMyStringMUS) Size(v AllMyString) (size int) {
	return stringw34tGwΔtΣ2CMjNLGw8rplQΞΞ.Size(string(v))
}

func (s allMyStringMUS) Skip(bs []byte) (n int, err error) {
	return stringw34tGwΔtΣ2CMjNLGw8rplQΞΞ.Skip(bs)
}
