...
func (s mySliceMUS) Marshal(v MySlice[MyInt], bs []byte) (n int) {
	return slice4tOHcqvYzmXGY9wPuaTnOQΞΞ.Marshal([]MyInt(v), bs)
}

func (s mySliceMUS) Unmarshal(bs []byte) (v MySlice[MyInt], n int, err error) {
	tmp, n, err := slice4tOHcqvYzmXGY9wPuaTnOQΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
	v = MySlice[MyInt](tmp)
...
func (s mySliceMUS) Size(v MySlice[MyInt]) (size int) {
	return slice4tOHcqvYzmXGY9wPuaTnOQΞΞ.Size([]MyInt(v))
}

func (s mySliceMUS) Skip(bs []byte) (n int, err error) {
	return slice4tOHcqvYzmXGY9wPuaTnOQΞΞ.Skip(bs)
}
...
func (s myArrayMUS) Marshal(v MyArray[int], bs []byte) (n int) {
	return arrayyHTGMyyfog8dmbpΔgslidgΞΞ.Marshal([3]int(v), bs)
}

func (s myArrayMUS) Unmarshal(bs []byte) (v MyArray[int], n int, err error) {
	tmp, n, err := arrayyHTGMyyfog8dmbpΔgslidgΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
	v = MyArray[int](tmp)
...
func (s myArrayMUS) Size(v MyArray[int]) (size int) {
	return arrayyHTGMyyfog8dmbpΔgslidgΞΞ.Size([3]int(v))
}

func (s myArrayMUS) Skip(bs []byte) (n int, err error) {
	return arrayyHTGMyyfog8dmbpΔgslidgΞΞ.Skip(bs)
}
...
func (s myMapMUS) Marshal(v MyMap[MyArray[int], MyInt], bs []byte) (n int) {
	return mapdddXDBOiT1khAt1u4pUfyAΞΞ.Marshal(map[MyArray[int]]MyInt(v), bs)
}

func (s myMapMUS) Unmarshal(bs []byte) (v MyMap[MyArray[int], MyInt], n int, err error) {
	tmp, n, err := mapdddXDBOiT1khAt1u4pUfyAΞΞ.Unmarshal(bs)
	if err != nil {
		return
	}
...
func (s myMapMUS) Size(v MyMap[MyArray[int], MyInt]) (size int) {
	return mapdddXDBOiT1khAt1u4pUfyAΞΞ.Size(map[MyArray[int]]MyInt(v))
}

func (s myMapMUS) Skip(bs []byte) (n int, err error) {
	return mapdddXDBOiT1khAt1u4pUfyAΞΞ.Skip(bs)
}
