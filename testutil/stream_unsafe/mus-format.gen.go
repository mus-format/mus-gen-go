...
var (
	arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ = unsafe.NewArraySer[[3]int, int](unsafe.Int)
	mapE10weWD2bUFsFΔ99ZtPC9gΞΞ   = ord.NewMapSer[struct_testdata.MyInt, []struct_testdata.MyStruct](MyIntMUS, sliceg4kHXcQZEPYVmΣFjzIveywΞΞ)
	mapupMU1hoKRghnk5PSdrfaEQΞΞ   = ord.NewMapSer[float32, map[struct_testdata.MyInt][]struct_testdata.MyStruct](unsafe.Float32, mapE10weWD2bUFsFΔ99ZtPC9gΞΞ)
	ptr0xIXdywa9Uv3Gmn2jHnLSAΞΞ   = ord.NewPtrSer[struct_testdata.MyStruct](MyStructMUS)
	ptrkvA3NW8WaeChMSB2APoR5wΞΞ   = ord.NewPtrSer[string](unsafe.String)
	ptrt9WwE2Z7ugro3j0IIwΣONAΞΞ   = ord.NewPtrSer[[3]int](arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ)
	sliceAMFVnyAaxzkDrI3BjnPnxQΞΞ = ord.NewSliceSer[string](unsafe.String)
	sliceg4kHXcQZEPYVmΣFjzIveywΞΞ = ord.NewSliceSer[struct_testdata.MyStruct](MyStructMUS)
)
...
func (s mySliceMUS) Marshal(v struct_testdata.MySlice, w mus.Writer) (n int, err error) {
	return sliceAMFVnyAaxzkDrI3BjnPnxQΞΞ.Marshal([]string(v), w)
}

func (s mySliceMUS) Unmarshal(r mus.Reader) (v struct_testdata.MySlice, n int, err error) {
	tmp, n, err := sliceAMFVnyAaxzkDrI3BjnPnxQΞΞ.Unmarshal(r)
	if err != nil {
		return
	}
...
func (s mySliceMUS) Size(v struct_testdata.MySlice) (size int) {
	return sliceAMFVnyAaxzkDrI3BjnPnxQΞΞ.Size([]string(v))
}

func (s mySliceMUS) Skip(r mus.Reader) (n int, err error) {
	return sliceAMFVnyAaxzkDrI3BjnPnxQΞΞ.Skip(r)
}
...
func (s complexStructMUS) Marshal(v struct_testdata.ComplexStruct, w mus.Writer) (n int, err error) {
	...
	n1, err = sliceg4kHXcQZEPYVmΣFjzIveywΞΞ.Marshal(v.StructSlice, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ.Marshal(v.Array, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Marshal(v.PtrString, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptr0xIXdywa9Uv3Gmn2jHnLSAΞΞ.Marshal(v.PtrStruct, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Marshal(v.NilPtr, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptrt9WwE2Z7ugro3j0IIwΣONAΞΞ.Marshal(v.PtrArray, w)
	n += n1
	if err != nil {
		return
	}
	n1, err = mapupMU1hoKRghnk5PSdrfaEQΞΞ.Marshal(v.Map, w)
	n += n1
	if err != nil {
		return
	}
...
func (s complexStructMUS) Unmarshal(r mus.Reader) (v struct_testdata.ComplexStruct, n int, err error) {
	...
	v.StructSlice, n1, err = sliceg4kHXcQZEPYVmΣFjzIveywΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.Array, n1, err = arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.PtrString, n1, err = ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.PtrStruct, n1, err = ptr0xIXdywa9Uv3Gmn2jHnLSAΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.NilPtr, n1, err = ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.PtrArray, n1, err = ptrt9WwE2Z7ugro3j0IIwΣONAΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
	v.Map, n1, err = mapupMU1hoKRghnk5PSdrfaEQΞΞ.Unmarshal(r)
	n += n1
	if err != nil {
		return
	}
...
func (s complexStructMUS) Size(v struct_testdata.ComplexStruct) (size int) {
	...
	size += sliceg4kHXcQZEPYVmΣFjzIveywΞΞ.Size(v.StructSlice)
	size += arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ.Size(v.Array)
	size += ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Size(v.PtrString)
	size += ptr0xIXdywa9Uv3Gmn2jHnLSAΞΞ.Size(v.PtrStruct)
	size += ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Size(v.NilPtr)
	size += ptrt9WwE2Z7ugro3j0IIwΣONAΞΞ.Size(v.PtrArray)
	size += mapupMU1hoKRghnk5PSdrfaEQΞΞ.Size(v.Map)
...
func (s complexStructMUS) Skip(r mus.Reader) (n int, err error) {
	...
	n1, err = sliceg4kHXcQZEPYVmΣFjzIveywΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
	n1, err = arrayyfcUKjNΣCOfDKFI4AWtNkQΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptrkvA3NW8WaeChMSB2APoR5wΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
	n1, err = ptr0xIXdywa9Uv3Gmn2jHnLSAΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
	...
	n1, err = ptrt9WwE2Z7ugro3j0IIwΣONAΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
	n1, err = mapupMU1hoKRghnk5PSdrfaEQΞΞ.Skip(r)
	n += n1
	if err != nil {
		return
	}
